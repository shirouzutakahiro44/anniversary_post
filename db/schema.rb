...
ActiveRecord::Schema[7.1].define(version: 2024_05_12_025025) do
...
name: "index_active_storage_variant_records_uniqueness", unique: true
  ...
  create_table "child_anniversaries", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci",
                                      force: :cascade do |t|
    t.string "name"
    t.date "date"
    t.text "description"
    ...
    t.index ["user_id"], name: "index_child_anniversaries_on_user_id"
  end

  create_table "child_posts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci",
                              force: :cascade do |t|
    t.string "content"
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "comments", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci",
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["child_post_id"], name: "index_comments_on_child_post_id"
  ...
  create_table "favorites", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci",
                            force: :cascade do |t|
    t.integer "user_id"
    t.integer "child_post_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "child_post_id"], name: "index_favorites_on_user_id_and_child_post_id",
                                          unique: true
  end

  create_table "hashtag_posts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci",
                                force: :cascade do |t|
  ...
  create_table "hashtags", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci",
                           force: :cascade do |t|
    t.string "hashname"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "notifications", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci",
                                force: :cascade do |t|
    t.integer "user_id"
    t.integer "child_post_id"
    t.integer "variety"
  ...
  create_table "relationships", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci",
                                force: :cascade do |t|
